...
{[
  ["B_supplyCrate_F","Empty Cargo Box","\A3\Ui_f\data\IGUI\Cfg\simpleTasks\types\box_ca.paa",{ 
	...
	/*["B_CargoNet_01_ammo_F","FOB Munitions Pallet","\A3\Ui_f\data\IGUI\Cfg\simpleTasks\types\box_ca.paa",{ 
        clearItemCargoGlobal _this; 
        clearMagazineCargoGlobal _this; 
        clearWeaponCargoGlobal _this; 
        clearBackpackCargoGlobal _this;
	...
	/*["CargoNet_01_barrels_F","FOB Fuel Pallet","\A3\Ui_f\data\IGUI\Cfg\simpleTasks\types\box_ca.paa",{ 
        clearItemCargoGlobal _this; 
        clearMagazineCargoGlobal _this; 
        clearWeaponCargoGlobal _this; 
        clearBackpackCargoGlobal _this;
	...
	/*["CargoNet_01_box_F","FOB Construction Supplies (250)","\A3\Ui_f\data\IGUI\Cfg\simpleTasks\types\box_ca.paa",{ 
        clearItemCargoGlobal _this; 
        clearMagazineCargoGlobal _this; 
        clearWeaponCargoGlobal _this; 
        clearBackpackCargoGlobal _this;	
		_this addItemCargoGlobal ["ACE_Fortify",10];
		[[],"RCOP\RCOFortify\RCOFcheckForNewFortifyVehicles.sqf"] remoteExec ["execVM",0];
		[_this, true, [0, 2, 0.5], 45] call ace_dragging_fnc_setDraggable;
    }], */
 ...
 ["B_supplyCrate_F","Communications, Personal Equipment, and Uniforms Box","\A3\Ui_f\data\IGUI\Cfg\simpleTasks\types\backpack_ca.paa",{ 
        ...
        clearWeaponCargoGlobal _this; 
        clearBackpackCargoGlobal _this;  
	  _this addItemCargoGlobal ["1PH_TS_Camo",5]; 
	  _this addItemCargoGlobal ["1PH_TS_Camo_SS",5]; 
 ...
 ["B_supplyCrate_F","x100 30Rnd FAL Magazines","\A3\Ui_f\data\IGUI\Cfg\simpleTasks\types\rifle_ca.paa",{ 
        clearItemCargoGlobal _this; 
        clearMagazineCargoGlobal _this; 
        clearWeaponCargoGlobal _this; 
        clearBackpackCargoGlobal _this; 
        _this addMagazineCargoGlobal ["CUP_30Rnd_762x51_FNFAL_M",70];
		_this addMagazineCargoGlobal ["CUP_30Rnd_TE1_Red_Tracer_762x51_FNFAL_M",30];
		[_this, true, [0, 2, 0.5], 45] call ace_dragging_fnc_setDraggable;
    }],  
 ...
 /*["B_supplyCrate_F","Food and Water","\A3\Ui_f\data\IGUI\Cfg\simpleTasks\types\meet_ca.paa",{ 
        clearItemCargoGlobal _this; 
        clearMagazineCargoGlobal _this; 
        clearWeaponCargoGlobal _this; 
        clearBackpackCargoGlobal _this; 
		_this addItemCargoGlobal ["ACE_MRE_BeefStew",20]; 
		_this addItemCargoGlobal ["ACE_MRE_ChickenTikkaMasala",20]; 
		_this addItemCargoGlobal ["ACE_MRE_ChickenHerbDumplings",20]; 
		_this addItemCargoGlobal ["ACE_MRE_CreamChickenSoup",20]; 
		_this addItemCargoGlobal ["ACE_MRE_CreamTomatoSoup",20]; 
		_this addItemCargoGlobal ["ACE_MRE_LambCurry",20]; 
		_this addItemCargoGlobal ["ACE_MRE_MeatballsPasta",20]; 
		_this addItemCargoGlobal ["ACE_MRE_SteakVegetables",20]; 
		_this addItemCargoGlobal ["ACE_WaterBottle", 150];
		[_this, true, [0, 2, 0.5], 45] call ace_dragging_fnc_setDraggable;
    }],*/
