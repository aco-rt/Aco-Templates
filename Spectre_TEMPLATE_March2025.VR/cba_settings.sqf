...
force ace_hearing_earplugsVolume = 0.450528;
...
ace_interact_menu_colorShadowMin = [0,0,0,0.5];
...
ace_interact_menu_menuBackgroundSelf = 2;
...
ace_map_gestures_nameTextColor = [1,1,1,1];
...
force force ace_medical_AIDamageThreshold = 0;
...
force force ace_medical_treatment_cprSuccessChanceMax = 0.654148;
force force ace_medical_treatment_cprSuccessChanceMin = 0.4;
force force ace_medical_treatment_graveDiggingMarker = false;
...
force force ace_finger_indicatorColor = [1,0.207899,0.21,0.833681];
...
// ACE Trenches
force force ace_trenches_bigEnvelopeDigDuration = 90;
force force ace_trenches_bigEnvelopeRemoveDuration = 45;
force force ace_trenches_smallEnvelopeDigDuration = 45;
...
force force ace_overpressure_backblastDistanceCoefficient = 0.451959;
force force ace_overpressure_overpressureDistanceCoefficient = 0.451959;
...
ace_viewdistance_viewDistanceAirVehicle = 3196;
ace_viewdistance_viewDistanceLandVehicle = 4595;
ace_viewdistance_viewDistanceOnFoot = 3142;
...
force force acex_volume_reduction = 7;
...
force force acre_sys_core_terrainLoss = 0.497159;
force force acre_sys_core_ts3ChannelName = "ACRE";
force force acre_sys_core_ts3ChannelPassword = "omega";
...
force force RCOBMS_directSharingToggle = true;
force force RCOBMS_rangedSharingToggle = true;
...
force force diwako_dui_font = "RobotoCondensedLight";
...
force force diwako_dui_compass_opacity = 0.800653;
...
force force emr_main_hintType = 1;
...
force force grad_paceCountBeads_functions_constantlyShow = false;
force force grad_paceCountBeads_functions_showOnChange = true;
...
force force grad_trenches_functions_bigEnvelopeDigTime = 65;
...
force force grad_trenches_functions_shortEnvelopeDigTime = 40;
...
force force grad_trenches_functions_vehicleEnvelopeDigTime = 160;
...
force force hatg_setting_enable_crouch = false;
force force hatg_setting_movement_crouch = 12;
...
force force hatg_setting_ui_colour_hidden = [0,1,0,1];
force force hatg_setting_ui_colour_revealed = [1,0,0,1];
force force hatg_setting_ui_fade = 0;
force force hatg_setting_ui_font = "PuristaBold";
force force hatg_setting_ui_textsize = 2;
force force hatg_setting_ui_use_image = false;
...
force force lambs_danger_panicChance = 0.15;
...
force force lambs_main_radioEast = 750;
force force lambs_main_radioGuer = 750;
force force lambs_main_radioShout = 100;
force force lambs_main_radioWest = 750;
...
force force tint_houseLimit = 20;
