			...
			if(count _num >2) then
				{
					...
					wsquadRP1 setVehiclePosition [(player modelToWorld[2,2,0]), [],0.2, "CAN_COLLIDE"];
					wsquadRP2 setVehiclePosition [(player modelToWorld[-2,3,0]), [],0.2, "CAN_COLLIDE"];
					wsquadRP3 setVehiclePosition [(player modelToWorld[-2,2,0]), [],0.2, "CAN_COLLIDE"];
...
[player, 1, ["ACE_SelfActions","Spectre"], _wBeacon1] call ace_interact_menu_fnc_addActionToObject;
...
[player, 1, ["ACE_SelfActions","Spectre"], _wBeacon2] call ace_interact_menu_fnc_addActionToObject;
...
[player, 1, ["ACE_SelfActions","Spectre"], _wBeacon3] call ace_interact_menu_fnc_addActionToObject;